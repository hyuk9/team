...
DROP SEQUENCE SQ_DINERIMAGE;
CREATE SEQUENCE SQ_DINERIMAGE START WITH 1 INCREMENT BY 1;
...
DROP TABLE TB_DINERIMAGE CASCADE CONSTRAINTS;
...
CREATE TABLE TB_DINERIMAGE
(
    DINO   NUMBER NOT NULL PRIMARY KEY,
    DNO    NUMBER, --JOIN용 컬럼
    PHOTO  VARCHAR2(2000),
    PHOTO2 VARCHAR2(2000),
    PHOTO3 VARCHAR2(2000),
    DELETE_YN   VARCHAR2(1) DEFAULT 'N',
    INSERT_TIME VARCHAR2(255),
    UPDATE_TIME VARCHAR2(255),
    DELETE_TIME VARCHAR2(255)
