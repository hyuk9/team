...
VALUES (SQ_COMMENT.nextval, 1, 1, 1, 'forbob', '사이트에 에러가 너무 많아요 어떻하죠', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 2, 1, 1, 'forbob', '답변122222222222222', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 1, 2, 2, 'JANGDH', '버전2는 얼마나 업그레이드 되나요?', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 2, 2, 2, 'JANGDH', '답변22222222222', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 1, 3, 3, 'JOSM', '버전은 몇까지 나오나요?', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 2, 3, 3, 'JOSM', '답변333333333', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 1, 4, 4, 'JUNSH','버전2에서는 예약기능이 잘 작동할까요?', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 2, 4, 4, 'JUNSH','답변44444444444', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 1, 5, 5, 'KWONTH', '버전2에서는 게시판을 좀더 예쁘게 만들고 깊어요', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 2, 5, 5, 'KWONTH', '답변5555555555', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 1, 6, 6, 'PARKSY','답변666666666', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 2, 6, 6, 'PARKSY','답변6666666666', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
...
VALUES (SQ_DINER.nextval, '합천국밥집', '4.6', '부산광역시 남구 용호로 235', '051-628-4898', '한식', '식사',
        ...
        129.111258148054, 2222, 0, '메뉴1', 10000, '메뉴2', 20000, '메뉴3', 30000, '메뉴4', 40000, '메뉴5', 50000, 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_DINER
VALUES (SQ_DINER.nextval, '톤쇼우', '4.1', '부산 금정구 금강로 247-10', '051-517-1727', '중식', '데이트',
        ...
        129.084270106003, 3333, 0, '메뉴1', 10000, '메뉴2', 20000, '메뉴3', 30000, '메뉴4', 40000, '메뉴5', 50000, 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_DINER
VALUES (SQ_DINER.nextval, '미청식당', '4.3', '부산광역시 기장군 일광읍 기장해안로 1303', '051-721-7050', '한식', '모임',
        ...
        129.233171640935, 4444, 0, '메뉴1', 10000, '메뉴2', 20000, '메뉴3', 30000, '메뉴4', 40000, '메뉴5', 50000, 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_DINER
VALUES (SQ_DINER.nextval, '백객도', '4.3', '부산광역시 동래구 금정마을로 70', '051-554-5873', '중식', '모임',
        ...
        129.063469116458, 5555, 0, '메뉴1', 10000, '메뉴2', 20000, '메뉴3', 30000, '메뉴4', 40000, '메뉴5', 50000, 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_DINER
VALUES (SQ_DINER.nextval, '디젤앤카멜리아스', '4.3', '부산 해운대구 우동1로20번길 11', '010-9179-6960', '일식', '회식',
        ...
        129.157214149098, 4434, 0, '메뉴1', 10000, '메뉴2', 20000, '메뉴3', 30000, '메뉴4', 40000, '메뉴5', 50000, 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_DINER
VALUES (SQ_DINER.nextval, '옥천횟집', '4.4', '부산 영도구 중리남로 2-21', '051-403-7771', '한식', '데이트',
        ...
        129.065989160108, 1231, 0, '메뉴1', 10000, '메뉴2', 20000, '메뉴3', 30000, '메뉴4', 40000, '메뉴5', 50000, 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_DINER
VALUES (SQ_DINER.nextval, '다온나루', '3.4', '부산 강서구 범방3로46번길 21', '051-832-1771', '중식', '데이트',
        ...
        128.882125351713, 1231, 0, '메뉴1', 10000, '메뉴2', 20000, '메뉴3', 30000, '메뉴4', 40000, '메뉴5', 50000, 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_DINER
VALUES (SQ_DINER.nextval, '금수복국', '4.4', '부산 해운대구 중동1로43번길 23', '051-742-3600', '양식', '식사',
        ...
        129.164490214477, 1233, 0, '메뉴1', 10000, '메뉴2', 20000, '메뉴3', 30000, '메뉴4', 40000, '메뉴5', 50000, 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_DINER
VALUES (SQ_DINER.nextval, '초원복국', '4.2', '부산 남구 황령대로492번길 30', '051-628-3935', '한식', '식사',
        ...
        129.105897235154, 1234, 0, '메뉴1', 10000, '메뉴2', 20000, '메뉴3', 30000, '메뉴4', 40000, '메뉴5', 50000, 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_DINER
VALUES (SQ_DINER.nextval, '양자강', '3.8', '부산 금정구 금단로 191', '051-583-1266', '중식', '모임',
        ...
        129.093514580494, 1114, 0, '메뉴1', 10000, '메뉴2', 20000, '메뉴3', 30000, '메뉴4', 40000, '메뉴5', 50000, 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_DINER
VALUES (SQ_DINER.nextval, '일광대복집', '4.3', '부산 기장군 일광읍 이화로 3', '051-721-1561', '한식', '회식',
        ...
        129.23351097849, 2222, 0, '메뉴1', 10000, '메뉴2', 20000, '메뉴3', 30000, '메뉴4', 40000, '메뉴5', 50000, 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_DINER
VALUES (SQ_DINER.nextval, '오노고로', '3.9', '부산 동래구 명륜로 150 1층', '0507-1347-2015', '중식', '데이트',
        ...
        129.082162483988, 4433, 0, '메뉴1', 10000, '메뉴2', 20000, '메뉴3', 30000, '메뉴4', 40000, '메뉴5', 50000, 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_DINER
VALUES (SQ_DINER.nextval, '로바타아키', '4.2', '부산 부산진구 동천로85번길 8', '0507-1322-3415', '양식', '모임',
        ...
        129.061875359282, 2222, 0, '메뉴1', 10000, '메뉴2', 20000, '메뉴3', 30000, '메뉴4', 40000, '메뉴5', 50000, 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_DINER
VALUES (SQ_DINER.nextval, '일구향만두', '4.0', '부산 영도구 절영로49번길 24', '051-418-7285', '한식', '데이트',
        ...
        129.039721514353, 4533, 0, '메뉴1', 10000, '메뉴2', 20000, '메뉴3', 30000, '메뉴4', 40000, '메뉴5', 50000, 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);
INSERT INTO TB_DINER
VALUES (SQ_DINER.nextval, '대저할매국수', '2.7', '부산 강서구 대저중앙로 337', '051-973-0837', '한식', '회식',
        ...
        128.983687939244, 5454, 0, '메뉴1', 10000, '메뉴2', 20000, '메뉴3', 30000, '메뉴4', 40000, '메뉴5', 50000, 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'), NULL, NULL);


-- Todo:리뷰 테이블 // ID / DNO 순서
INSERT INTO TB_REVIEW
VALUES (SQ_REVIEW.nextval, '2', '1', '장동혁', '유저2번', 'N',
        TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'),
        NULL, NULL);
INSERT INTO TB_REVIEW
VALUES (SQ_REVIEW.nextval, '3', '1', '조성모', '유저3번', 'N',
        TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'),
        NULL, NULL);
INSERT INTO TB_REVIEW
VALUES (SQ_REVIEW.nextval, '3', '2', '조성모', '유저3번', 'N',
        TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'),
        NULL, NULL);
INSERT INTO TB_REVIEW
VALUES (SQ_REVIEW.nextval, '5', '3', '권태현', '유저5번', 'N',
        TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'),
        NULL, NULL);
INSERT INTO TB_REVIEW
VALUES (SQ_REVIEW.nextval, '4', '4', '전성혜', '유저4번', 'N',
        TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'),
        NULL, NULL);
INSERT INTO TB_REVIEW
VALUES (SQ_REVIEW.nextval, '6', '5', '박선영', '유저6번', 'N',
        TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'),
        NULL, NULL);
INSERT INTO TB_REVIEW
VALUES (SQ_REVIEW.nextval, '6', '6', '박선영', '유저6번', 'N',
        TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'),
        NULL, NULL);
INSERT INTO TB_REVIEW
VALUES (SQ_REVIEW.nextval, '4', '7', '전성혜', '유저4번', 'N',
        TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'),
        NULL, NULL);
INSERT INTO TB_REVIEW
VALUES (SQ_REVIEW.nextval, '2', '8', '장동혁', '유저2번', 'N',
        TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'),
        NULL, NULL);
INSERT INTO TB_REVIEW
VALUES (SQ_REVIEW.nextval, '3', '9', '조성모', '유저3번', 'N',
        TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'),
        NULL, NULL);
INSERT INTO TB_REVIEW
VALUES (SQ_REVIEW.nextval, '3', '10', '조성모', '유저3번', 'N',
        TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'),
        NULL, NULL);
INSERT INTO TB_REVIEW
VALUES (SQ_REVIEW.nextval, '4', '11', '전성혜', '유저4번', 'N',
        TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'),
        NULL, NULL);
INSERT INTO TB_REVIEW
VALUES (SQ_REVIEW.nextval, '2', '12', '장동혁', '유저2번', 'N',
        TO_CHAR(SYSDATE, 'YYYY-MM-DD HH24:MI:SS'),
        NULL, NULL);



-- -- Todo: 평점 테이블 // TASTE / SERVICE / LOC / MOOD / COST / DNO / RNO / GENDER
-- -- Todo: 리뷰 테이블이랑 조인 예정
