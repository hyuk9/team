...
VALUES (SQ_QUESTION.nextval, '질문', '내용', 1, 0, 'forbob', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD'), NULL, NULL);
INSERT INTO TB_QUESTION
VALUES (SQ_QUESTION.nextval, '질문2', '내용2', 2, 0, 'JANGDH', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD'), NULL, NULL);
INSERT INTO TB_QUESTION
VALUES (SQ_QUESTION.nextval, '질문3', '내용3', 3, 0, 'JOSM', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD'), NULL, NULL);
INSERT INTO TB_QUESTION
VALUES (SQ_QUESTION.nextval, '질문4', '내용4', 4, 0, 'JUNSH', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD'), NULL, NULL);
INSERT INTO TB_QUESTION
VALUES (SQ_QUESTION.nextval, '질문5', '내용5', 5, 0, 'KWONTH', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD'), NULL, NULL);
INSERT INTO TB_QUESTION
VALUES (SQ_QUESTION.nextval, '질문6', '내용6', 6, 0, 'PARKSY', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD'), NULL, NULL);

-- Todo:댓글 테이블 세분화
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 1, 1, 1, 'forbob', '답변1', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 2, 1, 1, 'forbob', '답변1', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 1, 2, 2, 'JANGDH', '답변2', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 2, 2, 2, 'JANGDH', '답변2', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 1, 3, 3, 'JOSM', '답변3', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 2, 3, 3, 'JOSM', '답변3', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 1, 4, 4, 'JUNSH','답변4', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 2, 4, 4, 'JUNSH','답변4', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 1, 5, 5, 'KWONTH', '답변5', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 2, 5, 5, 'KWONTH', '답변5', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 1, 6, 6, 'PARKSY','답변6', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD'), NULL, NULL);
INSERT INTO TB_COMMENT
VALUES (SQ_COMMENT.nextval, 2, 6, 6, 'PARKSY','답변6', 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD'), NULL, NULL);
...
VALUES (SQ_COLUMN.nextval, '연말연시 맛집 추천', '한 해의 마지막과 새해의 시작을 이곳에서', '사진', '장동혁', '2', 0, 'N',
        TO_CHAR(SYSDATE, 'YYYY-MM-DD'), NULL, NULL);
INSERT INTO TB_COLUMN
VALUES (SQ_COLUMN.nextval, '서면 맛집 Best5', '부산토박이가 알려주는 로컬맛집', '사진2', '전성혜', '4', 0, 'N', TO_CHAR(SYSDATE, 'YYYY-MM-DD'),
        NULL, NULL);
INSERT INTO TB_COLUMN
