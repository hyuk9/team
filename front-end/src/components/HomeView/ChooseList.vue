      ...
      <div class="row gx-2">
        <div class="row gx-2">
          <div
            ...
            id="carouselLocationItemsInChooseList"
            data-bs-touch="false"
          ...
          >
            <div class="carousel-inner">
              ...
              <div class="carousel-item active">
                <div
                  v-for="(data, index) in favorite.slice(0, 4)"
                  :key="index"
                  class="
              ...
              <div
                class="carousel-item"
                v-for="index in Math.ceil(favorite.length / 4) - 1"
                :key="index"
              >
                <div
                  v-for="(data, index) in favorite.slice(
                    countCarouselNum,
                    countCarouselNum + 4
                  )"
                  :key="index"
    ...
    retrieveDiner() {
      DinerDataService.getAll(
        ...
        .then((response) => {
          ...
          this.favoritecount = totalItems; // 스프링부트에서 전송한 페이지정보(총 건수)
          // 디버깅 콘솔에 정보 출력
          console.log(response.data);
        })
        // 실패하면 .catch() 에 에러가 전송됨
