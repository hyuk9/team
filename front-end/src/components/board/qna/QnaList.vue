    ...
    <div>
        ...
        <div class="container mt-2 mb-2">
          ...
          retrieveQna();
            ...
            <!-- <div class="col-md-12 offset-2"> <div class="mb-3"> Items per Page: <select
            v-model="pageSize" @change="handlePageSizeChange($event)"> <option v-for="size
            in pageSizes" :key="size" :value="size"> size : 3, 6, 9 {{ size }} </option>
            </select> </div> <b-pagination v-model="page" :total-rows="count"
            :per-page="pageSize" prev-text="Prev" next-text="Next"
            @change="handlePageChange"></b-pagination> </div> -->
            ...
            <div>
                        ...
                        <tr>
                            ...
                            <td>
                                <router-link :to="'/qna/' + data.qno">
                                    <span class="badge rounded-pill bg-warning text-dark">수정</span>
                                </router-link>
                            </td>
                        </tr>
                    </tbody>
                ...
                <!-- <router-link to="/add-qna/"> <span class="badge bg-warning
                text-dark">추가</span> </router-link> -->
                <!-- TODO: badge를 버튼으로 교체 -->
...
<script>
    ...
    export default {
        data() {
            return {
                qna: [], searchKeyword: "", searchSelect: "작성자",
        ...
        methods: {
            ...
            retrieveQna() {
                QnaDataService
                    .getAll(this.searchSelect, // select box 선택된 값
