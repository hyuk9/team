        ...
        <div class="col-lg-8">
          ...
          <article>
            ...
            <div class="btn-group btn-group-lg" role="group" aria-label="Basic example" style="width: 950px">
              <router-link to="#"><button type="button" class="btn btn-primary">찜</button></router-link>
              <router-link to="#"><button type="button" class="btn btn-primary">리뷰보기</button></router-link>
              <router-link to="/add-reservation"><button type="button" class="btn btn-primary">예약</button></router-link>
            </div>
          </article>
          <!-- Comments section-->
          <section class="mb-5">
