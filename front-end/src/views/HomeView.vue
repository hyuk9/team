          ...
          <div class="row h-100 gx-2 mt-7">
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-md-0 h-100 pb-4">
              <div class="card card-span h-100">
                <div class="position-relative"> <img class="img-fluid rounded-3 w-100" src="@/assets/img/species/korean.jpg" alt="..." />
                ...
                <div class="card-body px-0">
                  <h5 class="fw-bold text-1000 text-truncate">한식에 대한 설명</h5><span class="badge bg-soft-danger py-2 px-3"><span class="fs-1 text-danger">지금 바로 알아보기</span></span>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-md-0 h-100 pb-4">
              <div class="card card-span h-100">
                <div class="position-relative"> <img class="img-fluid rounded-3 w-100" src="@/assets/img/species/chinese.jpg" alt="..." />
                  <div class="card-actions">
                    <div class="badge badge-foodwagon bg-primary p-4">
                      <div class="d-flex flex-between-center">
                ...
                <div class="card-body px-0">
                  <h5 class="fw-bold text-1000 text-truncate">중식에 대한 설명</h5><span class="badge bg-soft-danger py-2 px-3"><span class="fs-1 text-danger">지금 바로 알아보기</span></span>
                </div><a class="stretched-link" href="#"></a>
              </div>
            </div>
            <!-- 중식 끝 -->
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-md-0 h-100 pb-4">
              <div class="card card-span h-100">
                <div class="position-relative"> <img class="img-fluid rounded-3 w-100" src="@/assets/img/species/italy.jpg" alt="..." />
                  <div class="card-actions">
                    <div class="badge badge-foodwagon bg-primary p-4">
                      <div class="d-flex flex-between-center">
                ...
                <div class="card-body px-0">
                  <h5 class="fw-bold text-1000 text-truncate">양식에 대한 설명</h5><span class="badge bg-soft-danger py-2 px-3"><span class="fs-1 text-danger">지금 바로 알아보기</span></span>
                </div><a class="stretched-link" href="#"></a>
              </div>
            </div>
            <!-- 양식 끝 -->
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-md-0 h-100 pb-4">
              <div class="card card-span h-100">
                <div class="position-relative"> <img class="img-fluid rounded-3 w-100" src="@/assets/img/species/japan.jpg" alt="..." />
                  <div class="card-actions">
                    <div class="badge badge-foodwagon bg-primary p-4">
                      <div class="d-flex flex-between-center">
                ...
                <div class="card-body px-0">
                  <h5 class="fw-bold text-1000 text-truncate">일식에 대한 설명</h5><span class="badge bg-soft-danger py-2 px-3"><span class="fs-1 text-danger">지금 바로 알아보기</span></span>
                </div><a class="stretched-link" href="#"></a>
              </div>
            </div>
            <!-- 일식 끝 -->
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-md-0 h-100 pb-4">
              <div class="card card-span h-100">
                <div class="position-relative"> <img class="img-fluid rounded-3 w-100" src="@/assets/img/species/dessert.jpg" alt="..." />
                  <div class="card-actions">
                    <div class="badge badge-foodwagon bg-primary p-4">
                      <div class="d-flex flex-between-center">
                        <div class="text-white fs-7">디저트</div>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="card-body px-0">
                  <h5 class="fw-bold text-1000 text-truncate">카페에 대한 설명</h5><span class="badge bg-soft-danger py-2 px-3"><span class="fs-1 text-danger">지금 바로 알아보기</span></span>
                </div><a class="stretched-link" href="#"></a>
              </div>
            </div>
            <!-- 카페 끝 -->
      ...
      <section class="py-8 overflow-hidden">
        <div class="container">
          <div class="row flex-center mb-6">
            <div class="col-lg-7">
              <h5 class="fw-bold fs-3 fs-lg-5 lh-sm text-center text-lg-start">원하는 음식을 찾아보세요</h5>
            </div>
                ...
                <div class="card-body py-0">
                  <div class="row justify-content-center">
                    ...
                    <div class="col-md-7 col-xl-5 col-xxl-4 p-4 p-lg-5">
                      <h1 class="card-title mt-xl-5 mb-4">여기는 <span class="text-primary"> 푸드컬럼 공간</span></h1>
                      <p class="fs-1">이쪽은 작업 끝나고 여유되면 공간채우는 식으로 하는게 좋을듯</p>
                      <div class="d-grid bottom-0"><a class="btn btn-lg btn-primary mt-xl-6" href="#!">자세히 알아보기<i class="fas fa-chevron-right ms-2"></i></a></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card card-span mb-3 shadow-lg">
                <div class="card-body py-0">
                  <div class="row justify-content-center">
                    ...
                    <div class="col-md-7 col-xl-5 col-xxl-4 p-4 p-lg-5">
                      <h1 class="card-title mt-xl-5 mb-4">무슨 내용을 <br><span class="text-primary">넣을지는 나중에</span></h1>
                      <p class="fs-1">푸드컬럼용 페이지를 추가로 생성해야되는 귀찮음이 있어서 일단 보류</p>
                      <div class="d-grid bottom-0"><a class="btn btn-lg btn-primary mt-xl-6" href="#!">자세히 알아보기<i class="fas fa-chevron-right ms-2"></i></a></div>
                    </div>
                  </div>
                </div>
              ...
              <div class="card card-span mb-3 shadow-lg">
                <div class="card-body py-0">
                  <div class="row justify-content-center">
                    ...
                    <div class="col-md-7 col-xl-5 col-xxl-4 p-4 p-lg-5">
                      <h1 class="card-title mt-xl-5 mb-4">필요없다고 생각하면 <br><span class="text-primary">과감하게 포기</span></h1>
                      <p class="fs-1">사용자가 직접 칼럼을 작성하는 식으로 만들어도 괜찮을거 같음</p>
                      <div class="d-grid bottom-0"><a class="btn btn-lg btn-primary mt-xl-6" href="#!">자세히 알아보기<i class="fas fa-chevron-right ms-2"></i></a></div>
                    </div>
                  </div>
                </div>
        ...
        <div class="container">
          <div class="row flex-center">
            <div class="col-xxl-9 py-7 text-center">
              <h1 class="fw-bold mb-4 text-white fs-6">혹시나 기능추가를 위한 공간 <br /> 어떤기능을 넣을까 </h1><a class="btn btn-danger" href="#"> 버튼도 만들어놨음 <i class="fas fa-chevron-right ms-2"></i></a>
            </div>
          </div>
        </div>
      </section>
